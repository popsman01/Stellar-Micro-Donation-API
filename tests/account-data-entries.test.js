...
describe('Account Data Entries (Manage Data Operations)', () => {
  ...
  describe('POST /wallets/:id/data - Set/Update Data Entry', () => {
    it('should successfully set a data entry with valid key and value', async () => {
    ...
    it('should allow empty value for nullification', async () => {
      const response = await request(app)
        .post(`/wallets/${testWalletDb.id}/data`)
        .set('Authorization', 'Bearer test-key-1')
        .send({
  ...
  describe('GET /wallets/:id/data - Fetch Data Entries', () => {
    it('should return empty entries for wallet with no data', async () => {
      const response = await request(app)
    ...
    it('should return data entries after setting them', async () => {
      // First set some data
      await request(app)
        .post(`/wallets/${testWalletDb.id}/data`)
        .set('Authorization', 'Bearer test-key-1')
    ...
    it('should reject for invalid wallet ID', async () => {
      const response = await request(app)
    ...
    it('should reject for non-existent wallet', async () => {
      const response = await request(app)
